...
**STRICT RULES:**
* ❌ **FORBIDDEN:** Creating .md files in `/Volumes/Cody/projects/winning-backend/` (except README.md)
* ❌ **FORBIDDEN:** Creating .md files in `/Volumes/Cody/projects/winning-backend/` (except README.md)
* ❌ **FORBIDDEN:** Creating .md files in `/Volumes/Cody/projects/winning-backend/Winning_UIV2/` (except README.md and CODY.md)
* ❌ **FORBIDDEN:** Creating scripts (.sh) in `/Volumes/Cody/projects/winning-backend/` (except start.sh)

**REQUIRED LOCATIONS:**

### Backend Documentation → `/Volumes/Cody/projects/winning-backend/docs/`
...
### Frontend Documentation → `/Volumes/Cody/projects/winning-backend/Winning_UIV2/docs/`
...
### Scripts → `/Volumes/Cody/projects/winning-backend/scripts/`
...
### **Required Locations:**
* **Schema Sync Script:** `/Volumes/Cody/projects/winning-backend/scripts/sync-production-schema.py`
* **Documentation:** `/Volumes/Cody/projects/winning-backend/docs/deployment/SCHEMA_SYNC_GUIDE.md`
* **Alembic Migrations (for documentation):** `/Volumes/Cody/projects/winning-backend/alembic/versions/`
...
**Documentation:** See `/Volumes/Cody/projects/winning-backend/docs/deployment/SCHEMA_SYNC_GUIDE.md` for complete usage guide.
