...
**Service Layer:**
- `/Winning_UIV2/src/services/ConversionTrackingService.ts` (510 lines)
  - Singleton pattern
  - Session management
...
```bash
# 1. Start frontend
cd /Volumes/Cody/projects/winning-backend/Winning_UIV2
npm run dev
...
cd /Volumes/Cody/projects/winning-backend
...
### Frontend Files
- `/Winning_UIV2/src/services/ConversionTrackingService.ts` (510 lines) - Core service
- `/Winning_UIV2/src/hooks/useConversionTracking.ts` (74 lines) - React hooks
- `/Winning_UIV2/src/utils/apiClient.ts` (220 lines) - API client with CORS
...
- `/Winning_UIV2/src/services/__tests__/ConversionTrackingService.test.ts` - Frontend tests
