...
All issues MUST also comply with `/Volumes/Cody/projects/winning-backend/.ainative/RULES.MD`:
...
6. **NO THIRD-PARTY AI ATTRIBUTION:**
   - ❌ NEVER mention Claude, Anthropic, ChatGPT, Copilot or third-party AI tools in issues
   - ✅ Use professional, clear language
   - ✅ AINative branding allowed (Built by AINative, etc.)
   - ❌ No "Generated by [third-party tool]" phrases
