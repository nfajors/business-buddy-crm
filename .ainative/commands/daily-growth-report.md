...
Generate a comprehensive daily growth report for yesterday (or specified date) following the exact workflow documented in `/Volumes/Cody/projects/winning-backend/docs/reports/DAILY_REPORT_WORKFLOW.md`.
...
Connect using `DATABASE_PUBLIC_URL` from `/Volumes/Cody/projects/winning-backend/src/backend/.env`
...
`/Volumes/Cody/projects/winning-backend/docs/reports/DAILY_GROWTH_REPORT_[DATE].md`
...
✅ Report generated: /Volumes/Cody/projects/winning-backend/docs/reports/DAILY_GROWTH_REPORT_2025-12-28.md
...
- Workflow Documentation: `/Volumes/Cody/projects/winning-backend/docs/reports/DAILY_REPORT_WORKFLOW.md`
- Example Report: `/Volumes/Cody/projects/winning-backend/docs/reports/DAILY_GROWTH_REPORT_2025-12-28.md`
- MCP Query Reference: `/Volumes/Cody/projects/winning-backend/docs/reports/MCP_QUERY_REFERENCE.md`
- Project Rules: `/Volumes/Cody/projects/winning-backend/.claude/CLAUDE.md` (Rule 4: Data Gathering - MCP FIRST)
