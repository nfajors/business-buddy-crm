...
- **Location:** `/Volumes/Cody/projects/winning-backend/sdks/python`
...
```bash
cd /Volumes/Cody/projects/winning-backend/sdks/python
...
- **Location:** `/Volumes/Cody/projects/winning-backend/sdks/typescript/zerodb-mcp-client`
...
#### Step 1: Pre-Flight Testing
```bash
cd /Volumes/Cody/projects/winning-backend/sdks/typescript/zerodb-mcp-client
